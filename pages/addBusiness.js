...
export default class extends React.Component {
    ...
    handleOnChange = (e) => {
        ...
        switch (eventName) {
            ...
            case 'addressarea':
                console.log('handle change2 :', eventName, e.target.value);
                this.setState({ addressarea: e.target.value, errors: '' });
                break;
            case 'addressCity':
            ...
            case 'businessTags':
                console.log('handle change5 :', eventName, e.target.value);
                this.setState({ businessTags: e.target.value, errors: '' });
                break;
            case 'businessContactNumbers':
                console.log('handle change5 :', eventName, e.target.value);
                this.setState({ businessContactNumbers: e.target.value, errors: '' });
                break;
            case 'categoryType':
                console.log('handle change5 :', eventName, e.target.value);
    ...
    validateForm = () => {
        ...
        if (!this.state.addressarea) {
            formIsValid = false;
            errors["addressarea"] = "*Please enter your address area.";
        }
        if (!this.state.businessTags) {
            formIsValid = false;
        ...
        if (!this.state.businessContactNumbers) {
            formIsValid = false;
                ...
                <div className="inner-box">
                    ...
                    <div className="col-md-12 col-sm-12 col-sx-12">
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input className="form-control input-md" name="addressarea" value={this.state.addressarea} type="text" onChange={this.handleOnChange} />
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input className="form-control input-md" name="businessContactNumbers" value={this.state.businessContactNumbers} type="text" onChange={this.handleOnChange} />
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input className="form-control input-md" name="businessTags" value={this.state.businessTags} type="text" onChange={this.handleOnChange} />
