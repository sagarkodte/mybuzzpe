...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    _this.state = (_this$state = {
      ...
      value: 'Hourly',
      label: 'Hourly'
    }]), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(_this$state, "SelectedbudgetType", ''), _this$state);
    return _this;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(_default, [{
    ...
    value: function handleAddition(tag) {
      ...
      this.setState({
        ...
        console.log(typeof this.state.tags); //Object.keys(this.state.tags).map(function(k){return this.state.tags[k]}).join(",");

        var array = [];

        for (key in this.state.tags) {
          if (this.state.tags.hasOwnProperty(key)) {
            array.push(this.state.tags[key]);
          }
        }
...
//# sourceMappingURL=addProject.js.683d092c84b9da64da48.hot-update.js.map