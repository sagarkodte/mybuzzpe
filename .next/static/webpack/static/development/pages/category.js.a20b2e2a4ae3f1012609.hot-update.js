...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Index, [{
    ...
    value: function getCheckboxValue(event) {
      ...
      if (checked) {
        var a = this.state.checkboxValue1[this.state.current] ? this.state.checkboxValue1[this.state.current] : [];
        a.push(value);
...
//# sourceMappingURL=category.js.a20b2e2a4ae3f1012609.hot-update.js.map