    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "businessDetails", function () {
      if (_this.props.url.query.path !== '') {
        ...
        axios__WEBPACK_IMPORTED_MODULE_9___default.a.post(_config__WEBPACK_IMPORTED_MODULE_10___default.a.url + '/api/business/singlelist', data, {
          ...
          var product = '',
              service = '';
          axios__WEBPACK_IMPORTED_MODULE_9___default.a.post(_config__WEBPACK_IMPORTED_MODULE_10___default.a.url + '/api/catalog/list-short', businessId, {
            headers: {
              'Content-Type': 'application/json'
            }
          }).then(function (res) {
            ...
            console.log('businessId :', res.data.serviceData); //  product.push(res.data.productData);
            //  service.push(res.data.serviceData);

            product = res.data.productData.map(function (value, key) {
              console.log('description s :', value.description); //productDesc.push(value.description);

              return {
                description: value.description
              };
            });
            service = res.data.serviceData.map(function (value, key) {
              console.log('description s :', value.description); //serviceDesc.push(value.description);
...
//# sourceMappingURL=business.js.9003436cbda0f8fee2d7.hot-update.js.map