      ...
      if (_this.props.url.query.path !== '') {
        ...
        axios__WEBPACK_IMPORTED_MODULE_11___default.a.post(_config__WEBPACK_IMPORTED_MODULE_12___default.a.url + '/api/business/singlelist', data, {
          ...
          _this.setState({
            ...
            this.setState({
              addressLine1: this.state.businessDetails.addressLine1
            });
            this.setState({
              addressArea: this.state.businessDetails.addressArea
            });
            this.setState({
              addressCity: this.state.businessDetails.addressCity
            });
            this.setState({
              addressState: this.state.businessDetails.addressState
            });
            this.setState({
              addressPincode: this.state.businessDetails.addressPincode
            });
            this.setState({
              businessContactNumbers: this.state.businessDetails.businessContactNumbers
            });
            this.setState({
              businessTags: this.state.businessDetails.businessTags
            });
            this.setState({
              businessDescription: this.state.businessDetails.businessDescription
            });
            this.setState({
              selectedOption: this.state.businessDetails.businessCategory
            });
            this.setState({
              selectedSubOption: this.state.businessDetails.businessCategory
            });
          });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(_default, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(_Components_twoColumnLayout__WEBPACK_IMPORTED_MODULE_10__["default"], {
        ...
        __self: this
      }, "Select Category:"), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react_select__WEBPACK_IMPORTED_MODULE_9___default.a, {
        ...
        __self: this
      }, "Select Sub Category:"), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(react_select__WEBPACK_IMPORTED_MODULE_9___default.a, {
...
/***/ 4:
/*!*************************************!*\
  !*** multi ./pages/editBusiness.js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /workspace/mybuzzpe/pages/editBusiness.js */"./pages/editBusiness.js");
